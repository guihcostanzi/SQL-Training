...
/* 1 - FUNCIONARIOS QUE TRABALHAM NO DEPART. DE ROUPAS OU FILMES*/

/* Obs : A condição Roupas vai ser verificada primeiro pois há mais pessoas no departamento de Roupas (53)
do que no departamento de Filmes (21)*/

SELECT NOME AS FUNCIONÁRIO, SEXO, DEPARTAMENTO FROM FUNCIONARIOS
WHERE DEPARTAMENTO = 'Roupas' 
OR DEPARTAMENTO = 'Filmes';

/*2 - LISTA DE COLARADORAS ( F ) QUE TRABALHAM NO SETOR DE FILMES OU LAR , PARA ENVIO DE E-MAIL*/

/* Obs : A condição Lar vai ser verificada primeiro pois há mais pessoas no departamento de Lar (52)
do que no departamento de Filmes (21).

   A condição 'Feminino' será deixada por último, uma vez que há mais mulheres no Total do que pessoas nos dois setores, 
   e não há porquê verificar todas as mulheres, se podemos verificar apenas por setor primeiro. */

SELECT NOME AS FUNCIONÁRIA, DEPARTAMENTO, EMAIL FROM FUNCIONARIOS
WHERE (DEPARTAMENTO = 'Lar'
OR DEPARTAMENTO = 'Filmes')
AND SEXO = 'Feminino';

/* 3 - LISTA DE FUNCIONARIOS MASC. OU QUE TRABALHAM NO SETOR DE JARDIM*/

/* Como há muito mais homens do que pessoas no setor jardim, a condição Masculino será verificada primeiro. */
